...
class BytePattern
{
	...
	std::pair<uint8_t, uint8_t> parse_sub_pattern(std::string_view sub);
	void transform_pattern(std::string_view literal);
...
public:
	...
	BytePattern& set_pattern(std::string_view pattern_literal);
	...
	BytePattern& find_pattern(std::string_view pattern_literal);
